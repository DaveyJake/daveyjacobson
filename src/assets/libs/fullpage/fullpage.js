...
( function( window, document, factory, undefined ) {
    ...
    function initialise( containerSelector, options ) {
        ...
        //var isOK = options && new RegExp( '([\\d\\w]{8}-){3}[\\d\\w]{8}|^(?=.*?[A-Y])(?=.*?[a-y])(?=.*?[0-8])(?=.*?[#?!@$%^&*-]).{8,}$' ).test( options['li' + 'cen' + 'seK' + 'e' + 'y']) || -1 < document.domain.indexOf( 'al' + 'varotri' + 'go' + '.' + 'com' );
        ...
        var isTouch         = 'ontouchstart' in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints;
        ...
        window.fp_easings = deepExtend( window.fp_easings, {
            easeInOutCubic: function( t, b, c, d ) {
                if ( 1 > ( t /= d / 2 ) ) return c / 2 * t * t * t + b;return c / 2 * ( ( t -= 2 ) * t * t + 2 ) + b;
            }
        });
        ...
        */
        ...
        function delegatedEvents( e ) {
            ...
            } else if ( matches( target, SLIDES_NAV_LINK_SEL ) || null != closest( target, SLIDES_NAV_LINK_SEL ) ) {
        ...
        function onMouseEnterOrLeave( e ) {
            ...
            //fixing issue #3576
            if ( 'mouseenter' === e.type && ! g_canFireMouseEnterNormalScroll ) {
                return;
            }

            var normalSelectors = options.normalScrollElements.split( ',' );
            normalSelectors.forEach( function( normalSelector ) {
                if ( null != closest( e.target, normalSelector ) ) {
        ...
        */
        function styleSlides( section, slides, numSlides ) {
            ...
            if ( null != startingSlide && ( 0 !== index( $( SECTION_ACTIVE_SEL ), SECTION_SEL ) || 0 === index( $( SECTION_ACTIVE_SEL ), SECTION_SEL ) && 0 !== index( startingSlide ) ) ) {
        ...
        */
        function styleSection( section, index ) {
            ...
            if ( ! index && null == $( SECTION_ACTIVE_SEL )[0]) {
            ...
            if ( 'undefined' !==  typeof options.sectionsColor[index]) {
                css( section, {'background-color': options.sectionsColor[index]});
            }

            if ( 'undefined' !== typeof options.anchors[index]) {
        ...
        */
        function styleMenu( section, index ) {
            ...
            if ( options.menu && options.css3 && null != closest( $( options.menu )[0], WRAPPER_SEL ) ) {
        ...
        */
        function isDestinyTheStartingSection() {
            ...
            return ! destinationSection || 'undefined' !== typeof destinationSection && index( destinationSection ) === index( startingSection );
        }
        ...
        */
        function moveSlide( direction, section ) {
            ...
            if ( null == slides || slideMoving || 2 > $( SLIDE_SEL, slides ).length ) {
                return;
            }
        ...
        */
        function getDestinationPosition( element ) {
            ...
            if ( elementHeight > windowsHeight ) {
                ...
                //scrolling up?
                if ( ! isScrollingDown && ! bigSectionsDestination || 'bottom' === bigSectionsDestination ) {
                    position = sectionBottom;
                }
            }

            //sections equal or smaller than the viewport height && scrolling down? ||  is resizing and its in the last section
            else if ( isScrollingDown || isResizing && null == next( element ) ) {
 ...
 return;
            ...
            if ( ! v.localIsResizing ) {
                ...
                if ( 'undefined' !== typeof isMovementUp ) {
                ...
                if ( isFunction( options.onLeave ) ) {
                    if ( false === fireCallback( 'onLeave', v ) ) {
                        return;
                    }
                }
            }
            ...
            if ( options.autoScrolling && options.continuousVertical && "undefined" !== typeof v.isMovementUp &&
                (  ! v.isMovementUp && 'up' == v.yMovement || // Intending to scroll down but about to go up or
                v.isMovementUp && 'down' == v.yMovement ) ) { // intending to scroll up but about to go down
        ...
        */
        function fireCallback( eventName, v ) {
            ...
            if ( ! options.v2compatible ) {
                ...
                if ( false === options[eventName].apply( eventData[Object.keys( eventData )[0]], toArray( eventData ) ) ) {
                    return false;
                }
            } else {
                if ( false === options[eventName].apply( eventData[0], eventData.slice( 1 ) ) ) {
                    return false;
                }
            }
 ...
 return [ v.prevSlide, v.anchorLink, v.sectionIndex + 1, v.prevSlideIndex, v.direction, v.slideIndex ];
        ...
        */
        function playMedia( destiny ) {
            ...
            $( 'video, audio', panel ).forEach( function( element ) {
                if ( element.hasAttribute( 'data-autoplay' ) && 'function' === typeof element.play ) {
                    element.play();
                }
            });
        ...
        */
        function stopMedia( destiny ) {
            ...
            $( 'video, audio', panel ).forEach( function( element ) {
                if ( ! element.hasAttribute( 'data-keepplaying' ) && 'function' === typeof element.pause ) {
                    element.pause();
                }
            });
        ...
        */
        ...
        function getAnchorsURL() {
            ...
            if ( hash.length ) {
                ...
                var isFunkyAnchor = -1 < hash.indexOf( '#/' );
        ...
        function keydownHandler( e ) {
            ...
            if ( 9 === keyCode ) {
                ...
                "true" !== activeElement.getAttribute( 'contentEditable' ) && '' !== activeElement.getAttribute( 'contentEditable' ) &&
                options.keyboardScrolling && options.autoScrolling ) {

                //preventing the scroll with arrow keys & spacebar & Page Up & Down keys
                var keyControls = [ 40, 38, 32, 33, 34 ];
                if ( -1 < keyControls.indexOf( keyCode ) ) {
                    preventDefault( e );
                }
        ...
        */
        function onTab( e ) {
            ...
            if ( activeElement ) {
                if ( null == closest( activeElement, SECTION_ACTIVE_SEL + ',' + SECTION_ACTIVE_SEL + ' ' + SLIDE_ACTIVE_SEL ) ) {
        ...
        */
        function getFocusables( el ) {
            return [].slice.call( $( focusableElementsString, el ) ).filter( function( item ) {
                    return '-1' !== item.getAttribute( 'tabindex' ) &&

                    //are also not hidden elements (or with hidden parents)
                    null !== item.offsetParent;
            });
        }
        ...
        */
        function onkeydown( e ) {
            ...
            if ( ! canScroll && 0 > [ 37, 39 ].indexOf( e.keyCode ) ) {
                return;
            }
        ...
        */
        function landscapeScroll( slides, destiny, direction ) {
            ...
            if ( options.onSlideLeave ) {
                ...
                if ( ! v.localIsResizing && 'none' !== v.xMovement ) {
                    if ( isFunction( options.onSlideLeave ) ) {
                        if ( false === fireCallback( 'onSlideLeave', v ) ) {
                            slideMoving = false;
                            return;
                        }
                    }
        ...
        */
        function support3d() {
            ...
            return has3d !== undefined && 0 < has3d.length && 'none' !== has3d;
        }
        ...
        */
        function silentLandscapeScroll( activeSlide, noCallbacks ) {
            ...
            if ( 'undefined' !== typeof noCallbacks ) {
        ...
        */
        function destroyStructure() {
            ...
            $body.className.split( /\s+/ ).forEach( function( className ) {
                if ( 0 === className.indexOf( VIEWING_PREFIX ) ) {
    ...
    */
    function $( selector, context ) {
        context = 1 < arguments.length ? context : document;
    ...
    */
    function isArrayOrList( el ) {
        return '[object Array]' === Object.prototype.toString.call( el ) ||
    ...
    */
    ...
    function untilAll( item, selector, fn ) {
        ...
        var siblings = [];
        while ( sibling ) {
            if ( matches( sibling, selector ) || null == selector ) {
