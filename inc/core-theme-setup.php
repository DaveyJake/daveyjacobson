 ...
 */
if ( ! function_exists( 'dj_portfolio_setup' ) ) {

	function dj_portfolio_setup() {
		/*
		...
		add_theme_support(
			'custom-background', apply_filters(
				'dj_portfolio_custom_background_args', array(
 ...
 */
function dj_portfolio_content_width() {
...
add_action( 'after_setup_theme', 'dj_portfolio_setup' );
add_action( 'after_setup_theme', 'dj_portfolio_content_width', 0 );
