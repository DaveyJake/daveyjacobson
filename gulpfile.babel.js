...
function libs() {
  return ['fullpage', 'mmenuLight', 'parallax'].forEach( function( folder ) {
    gulp.src( PATHS.libs[ folder ] )
      .pipe( gulp.dest( PATHS.dist + '/assets/libs/' + folder ) )
  });
}
...
function watch() {
  ...
  gulp.watch( ['src/assets/scss/**/*.scss', 'src/assets/scss/*.scss'], sass )
